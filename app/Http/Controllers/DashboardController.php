...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $url =  'http://www.revenuesure.co.ke/RevenueSure/api/Account/GetUsers';
    ...
    public function storeRole(Request $request){
        ...
        $url=  'http://www.revenuesure.co.ke/RevenueSure/api/Account/AddRole';
    ...
    public function storeUser(Request $request){
        ...
        $url=  'http://www.revenuesure.co.ke/RevenueSure/api/Account/Register';
